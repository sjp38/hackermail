...
$HKML ls linux-mm 2 >> $OUT || exit 2
$HKML format_reply linux-mm 2 >> $OUT || exit 3
...
$HKML --hkml_dir .hkml ls linux-mm 2 >> $OUT || exit 2
$HKML --hkml_dir .hkml format_reply linux-mm 2 >> $OUT || exit 3
